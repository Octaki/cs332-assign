...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet =
    TweetReader.allTweets.filter((t: Tweet) => google.exists(keyword => t.text.contains(keyword)))
  lazy val appleTweets: TweetSet =
    TweetReader.allTweets.filter((t: Tweet) => apple.exists(keyword => t.text.contains(keyword)))
   ...
   */
     lazy val trending: TweetList = {
       val unionofTrend = googleTweets.union(appleTweets)
       unionofTrend.descendingByRetweet
     }
  }
